    ...
    return (
        <header className="w-full bg-white">
            ...
            <div className="w-full border-b border-gray-300">
                <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between relative">
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2">
                        <img src={Logo} alt="Ranowell Hotel" className="h-20 object-contain" />
                    </div>
            ...
            <nav className="max-w-7xl mx-auto px-6">
                ...
                {/* Desktop Nav */}
                <div className="hidden md:flex items-center justify-center gap-10 py-4 tracking-widest text-sm">
...
const NavItem = ({
    ...
    <Link
        to={to}
        onClick={onClick}
        className="hover:text-[#6A1B9A] transition cursor-pointer"
    >
        {label}
    </Link>
);
